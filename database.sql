...
INSERT INTO users (name, email, phone, role_id, department_id, status) VALUES 
  ('Admin User', 'admin@example.com', '1234567890', 3, 4, 'active'),
  ('Supervisor John', 'supervisor@example.com', '1234567891', 2, 1, 'active'),
  ('Support Agent Sarah', 'sarah@example.com', '1234567892', 2, 1, 'active'),
  ('Regular User John', 'john@example.com', '1234567893', 1, NULL, 'active'),
  ('Regular User Jane', 'jane@example.com', '1234567894', 1, NULL, 'active'),
  ('Billing Manager Mike', 'mike@example.com', '1234567895', 2, 2, 'active');
